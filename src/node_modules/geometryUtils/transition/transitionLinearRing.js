...
import { calculateCentroidLinearRing } from '../calculateCentroid.js'
...
export function implodeLinearRing (linearRing) {
  let centroid = calculateCentroidLinearRing(linearRing)
  let smallSquareAroundCentroid = getSmallSquareAroundPoint(centroid)

  return transitionLinearRing(linearRing, smallSquareAroundCentroid)
}
...
export function explodeLinearRing (linearRing) {
  ...
  return transitionLinearRing(smallSquareAroundCentroid, linearRing)
}

function getSmallSquareAroundPoint ([x, y]) {
  return [
    [x - 0.1, y - 0.1],
    [x - 0.1, y + 0.1],
    [x + 0.1, y + 0.1],
