import * as flubber from '../flubber.min.js'
...
export default function Polygon (fromPolygon, toPolygon) {
  ...
  let outerRingInterpolator = flubber.interpolate(fromOuterRing, toOuterRing)
  ...
  if (holes > 0) {
    ...
    for (let i = 1; i <= holes; i++) {
      ...
      let toHole = fromPolygon.coordinates[i]

      if (fromHole && toHole) {
        interpolatorArray.push(flubber.interpolate(fromHole, toHole))
      }
