...
return d[d.length-1];};return ", funcName].join("");
    ...
    const file = "src/components/Core/Graphic/Graphic.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(svg, file, 51, 0, 1601);
    		},
    ...
    class Graphic extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, ["width", "height", "scaleX", "scaleY", "renderer"]);
    ...
    const file$1 = "src/components/Core/Section/Section.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(g, file$1, 54, 0, 1824);
    		},
    ...
    /* src/components/Core/CoordinateTransformation/CoordinateTransformation.svelte generated by Svelte v3.6.5 */
    ...
    function instance$2($$self, $$props, $$invalidate) {
      ...
      const sectionContext = subscribe$2(); validate_store(sectionContext, 'sectionContext'); subscribe($$self, sectionContext, $$value => { $sectionContext = $$value; $$invalidate('$sectionContext', $sectionContext); });
      const coordinateTransformationContext = init$5();

    	const writable_props = ['transformation'];
    	Object.keys($$props).forEach(key => {
    		if (!writable_props.includes(key) && !key.startsWith('$$')) console.warn(`<CoordinateTransformation> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$.update = ($$dirty = { $sectionContext: 1, transformation: 1 }) => {
    		if ($$dirty.$sectionContext || $$dirty.transformation) { {
            let rangeX = $sectionContext.rangeX();
            let rangeY = $sectionContext.rangeY();
            update$5(coordinateTransformationContext, { rangeX, rangeY, transformation });
          } }
    	};
    ...
    class CoordinateTransformation extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, ["transformation"]);

    		const { ctx } = this.$$;
    		const props = options.props || {};
    		if (ctx.transformation === undefined && !('transformation' in props)) {
    			console.warn("<CoordinateTransformation> was created without expected prop 'transformation'");
    		}
    	}

    	get transformation() {
    		throw new Error("<CoordinateTransformation>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set transformation(value) {
    		throw new Error("<CoordinateTransformation>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    const file$2 = "src/components/Marks/Rectangle/RectangleLayer.svelte";
    ...
    function create_each_block(key_1, ctx) {
    	...
    	return {
    		...
    		c: function create() {
    			...
    			add_location(path, file$2, 148, 4, 4740);
    			this.first = path;
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	var if_block = (ctx.$graphicContext.output() === 'svg') && create_if_block(ctx);
    ...
    class RectangleLayer extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, ["x1", "x2", "y1", "y2", "fill", "opacity", "transition", "interpolate", "index", "onClick", "onMouseover", "onMouseout"]);
    	}
    ...
    */
    ...
    /* test/src/App.svelte generated by Svelte v3.6.5 */

    const file$3 = "test/src/App.svelte";

    // (72:4) <CoordinateTransformation {transformation}>
    function create_default_slot_2(ctx) {
    	var current;

    	var rectanglelayer = new RectangleLayer({
    		props: {
    		x1: ctx.filteredData.column('fruit'),
    		x2: ctx.func,
    		y1: 0,
    		y2: ctx.filteredData.column('meanQuantity'),
    		fill: ctx.transformation === 'identity' ? 'green' : 'blue',
    		index: ctx.filteredData.column('$index'),
    		onClick: ctx.func_1
    	},
    		$$inline: true
    	});
    	...
    	return {
    		...
    		p: function update(changed, ctx) {
    			...
    			if (changed.filteredData) rectanglelayer_changes.x1 = ctx.filteredData.column('fruit');
    			if (changed.filteredData) rectanglelayer_changes.x2 = ctx.func;
    			if (changed.filteredData) rectanglelayer_changes.y2 = ctx.filteredData.column('meanQuantity');
    			if (changed.transformation) rectanglelayer_changes.fill = ctx.transformation === 'identity' ? 'green' : 'blue';
    			if (changed.filteredData) rectanglelayer_changes.index = ctx.filteredData.column('$index');
    			if (changed.log) rectanglelayer_changes.onClick = ctx.func_1;
    ...
    // (65:2) <Section     x1={50} x2={450}     y1={50} y2={450}     scaleX={scaleFruit}    scaleY={scaleMeanQuantity}   >
    function create_default_slot_1(ctx) {
    	...
    	return {
    		c: function create() {
    			coordinatetransformation.$$.fragment.c();
    		},

    		m: function mount(target, anchor) {
    			mount_component(coordinatetransformation, target, anchor);
    			current = true;
    		},

    		p: function update(changed, ctx) {
    			var coordinatetransformation_changes = {};
    			if (changed.transformation) coordinatetransformation_changes.transformation = ctx.transformation;
    			if (changed.$$scope || changed.filteredData || changed.transformation) coordinatetransformation_changes.$$scope = { changed, ctx };
    			coordinatetransformation.$set(coordinatetransformation_changes);
    		},

    		i: function intro(local) {
    			if (current) return;
    			transition_in(coordinatetransformation.$$.fragment, local);

    			current = true;
    		},

    		o: function outro(local) {
    			transition_out(coordinatetransformation.$$.fragment, local);
    			current = false;
    		},

    		d: function destroy(detaching) {
    			destroy_component(coordinatetransformation, detaching);
    		}
    	};
    }

    // (59:0) <Graphic    width={500} {height}   scaleX={scaleLinear().domain([0, 500])}   scaleY={scaleLinear().domain([0, 500])} >
    function create_default_slot(ctx) {
    	...
    	return {
    		...
    		p: function update(changed, ctx) {
    			...
    			if (changed.$$scope || changed.transformation || changed.filteredData) section_changes.$$scope = { changed, ctx };
    ...
    function create_fragment$4(ctx) {
    	var h1, t1, div0, label0, t3, input0, t4, div1, label1, t6, select, option0, option1, t9, div2, label2, t11, input1, t12, div3, button, t14, current, dispose;
    	...
    	return {
    		c: function create() {
    			...
    			button.textContent = "Filter: fruit !== durian";
    			t14 = space();
    			graphic.$$.fragment.c();
    			add_location(h1, file$3, 35, 0, 991);
    			attr(label0, "for", "height-slider");
    			add_location(label0, file$3, 37, 2, 1018);
    			attr(input0, "type", "range");
    			attr(input0, "min", "0");
    			attr(input0, "max", "500");
    			attr(input0, "name", "height-slider");
    			add_location(input0, file$3, 38, 2, 1063);
    			add_location(div0, file$3, 36, 0, 1010);
    			attr(label1, "for", "coordinate-select");
    			add_location(label1, file$3, 42, 2, 1161);
    			option0.__value = "identity";
    			option0.value = option0.__value;
    			add_location(option0, file$3, 44, 4, 1281);
    			option1.__value = "polar";
    			option1.value = option1.__value;
    			add_location(option1, file$3, 45, 4, 1328);
    			if (ctx.transformation === void 0) add_render_callback(() => ctx.select_change_handler.call(select));
    			attr(select, "name", "coordinate-select");
    			add_location(select, file$3, 43, 2, 1215);
    			add_location(div1, file$3, 41, 0, 1153);
    			attr(label2, "for", "duration");
    			add_location(label2, file$3, 50, 2, 1393);
    			attr(input1, "name", "duration");
    			attr(input1, "type", "range");
    			attr(input1, "min", "100");
    			attr(input1, "max", "5000");
    			add_location(input1, file$3, 51, 2, 1441);
    			add_location(div2, file$3, 49, 0, 1385);
    			add_location(button, file$3, 55, 2, 1539);
    			add_location(div3, file$3, 54, 0, 1531);
    		...
    		p: function update(changed, ctx) {
    			if (changed.height) input0.value = ctx.height;
    			if (changed.transformation) select_option(select, ctx.transformation);
    			if (changed.duration) input1.value = ctx.duration;
    			...
    			if (changed.$$scope || changed.transformation || changed.filteredData) graphic_changes.$$scope = { changed, ctx };
    ...
    function instance$4($$self, $$props, $$invalidate) {
      ...
      const log = console.log;
    	...
    	function click_handler() {
    		const $$result = notAllowedfruit = 'durian';
    		$$invalidate('notAllowedfruit', notAllowedfruit);
    		return $$result;
    	}

    	function func({ scaleX }) {
    		return filteredData.map('fruit', v => scaleX(v) + scaleX.bandwidth() );
    	}
    	...
    	$$self.$$.update = ($$dirty = { data: 1, notAllowedfruit: 1 }) => {
    		if ($$dirty.data || $$dirty.notAllowedfruit) { $$invalidate('filteredData', filteredData = data
